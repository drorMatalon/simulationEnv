...
simCore.Connect("RxIir_0", "RxIir_1", "RxChannelEst", "RxAbs", "RxFir_0", "RxFir_1", "RxDec", "RxGain")
...
AwgnReg = BbAwgnReg(False, 0.6)
SdrReg = BbPlutoSdrReg(True, 600000, 1500000000, 1500000000, "slow_attack", -50)
...
RxGainReg = BbGainReg(False, 1/20)
...
simCore.StartFrame()
TxInGate.GenSig(100, "4QAM")
Scope.Connect("RxGain")
Scope.Plot("constellation")

TxIntReg.Update(False, 20)
TxFirReg.Update(False, np.ones(20))
RxFir1Reg.Update(False, np.ones(20))
RxDecReg.Update(False, 20)
